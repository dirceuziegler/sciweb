...
(function () {
  ...
  var p = "theme fullscreen autofit zoom-in zoom-out page title description player progress".split(
    ...
    Ha;
  function T(a) {
    return (M || document).getElementsByClassName(a)[0];
  }
  function Ia(a, b) {
    if ((F = a.length)) {
      J || (J = (M || document).getElementsByClassName("pane"));
      var c = J.length,
        d = G.title,
        e = G.description;
      S = Array(F);
      for (var k = 0; k < F; k++) {
        var t = a[k],
          w = t.dataset;
        if (k >= c) {
          var x = J[0].cloneNode(!1);
          l(x, "left", 100 * k + "%");
          J[0].parentNode.appendChild(x);
        }
        x = void 0;
        S[k] = {
  ...
  function Ma(a, b) {
    ...
    wa = a.onchange;
    H = G.infinite;
    H = "undefined" !== typeof H && "false" !== H;
    va = "false" !== G.progress;
    xa = 1 * G.player || 7e3;
    if ((a = G.zoom) || "" === a)
      (G["zoom-in"] = G["zoom-out"] = a), delete G.zoom;
    if ((a = G.control) || "" === a) {
      a = "string" === typeof a ? a.split(",") : a;
      for (b = 0; b < p.length; b++) G[p[b]] = "false";
      for (b = 0; b < a.length; b++) {
        var c = a[b].trim();
        "zoom" === c
          ? (G["zoom-in"] = G["zoom-out"] = "true")
          : (G[c] = "true");
      }
    }
    for (a = 0; a < p.length; a++)
      (b = p[a]), l(T(b), "display", "false" === G[b] ? "none" : "");
    (ua = G.theme) ? Oa() : (ua = "white");
  }
  function Na(a) {
    for (var b = G, c = Object.keys(a), d = 0; d < c.length; d++) {
      var e = c[d];
      b[e] = "" + a[e];
    }
  }
  function Pa() {
    var a = E;
    I = J[a - 1];
    K = I.firstElementChild;
    E = a;
    if (!K) {
      var b = "false" !== G.preloader;
      K = new Image();
      K.onload = function () {
        b && h(O, "show");
        S &&
          ...
          "false" !== G.prefetch && a < F && (new Image().src = S[a].src));
      };
      K.onerror = function () {
        I.removeChild(this);
      };
  ...
  la(document, "", Qa);
  la(document, "DOMContentLoaded", Ra, { once: !0 });
  var Sa = !1;
  function Ra() {
    Sa ||
      ...
      (Ha = [
        [window, "keydown", Ta],
        [window, "wheel", Ua],
        [window, "hashchange", Va],
        [window, "resize", Wa],
        [O, "mousedown", Xa],
        [O, "mouseleave", Ya],
        [O, "mouseup", Ya],
        [O, "mousemove", Za],
        [O, "touchstart", Xa, { passive: !1 }],
        [O, "touchcancel", Ya],
        [O, "touchend", Ya],
        [O, "touchmove", Za, { passive: !0 }],
        [N, "", $a],
        [Ba, "", ab],
        [Ca, "", U],
        [Ea, "", V],
  ...
  function Wa() {
    u = M.clientWidth;
    v = M.clientHeight;
    K && ((y = K.width), (z = K.height), fb());
  }
  function fb() {
    l(K, "transform", "translate(-50%, -50%) scale(" + A + ")");
  }
  function W(a, b) {
    l(I, "transform", a || b ? "translate(" + a + "px, " + b + "px)" : "");
  }
  function Ja(a, b) {
    (a ? m : l)(
      L,
      "transform",
      "translateX(" + (100 * -(E - 1) + (b || 0)) + "%)"
    );
  }
  function gb(a) {
    for (var b = 0; b < Ha.length; b++) {
      var c = Ha[b];
  ...
  function Ua(a) {
    I && ((a = a.deltaY), 0 > 0.5 * (0 > a ? 1 : a ? -1 : 0) ? db() : cb());
  }
  function Va() {
    I && "#spotlight" === location.hash && eb(!0);
  }
  function V(a) {
    ("boolean" === typeof a ? a : !P)
      ? P || ((P = setInterval(U, xa)), f(Ea, "on"), va && jb())
      : P &&
        ((P = clearInterval(P)), h(Ea, "on"), va && m(Fa, "transform", ""));
    return P;
  }
  function Y() {
    Q ? clearTimeout(Q) : f(M, "menu");
    var a = G.autohide;
    Q =
      "false" !== a
        ? setTimeout(function () {
  ...
  function kb(a) {
    "boolean" === typeof a && (Q = a ? Q : 0);
    Q ? ((Q = clearTimeout(Q)), h(M, "menu")) : Y();
    return n(a);
  }
  function Xa(a) {
    B = !0;
  ...
  function Ya(a) {
    if (B && !ra) return (B = !1), kb(a);
    sa &&
      ra &&
      (Ja(!0, (q / u) * 100),
      (q < -(v / 10) && U()) || (q > v / 10 && ab()) || Ja(),
      (q = 0),
      (sa = !1),
      W());
    B = !1;
  ...
  function Za(a) {
    if (B) {
      Ga || (Ga = requestAnimationFrame(mb));
      var b = lb(a),
        c = (y * A - u) / 2;
      ra = !0;
      q -= pa - (pa = b.x);
  ...
  function mb(a) {
    C ? (a && (Ga = requestAnimationFrame(mb)), W(q, r)) : (Ga = null);
    C = !1;
  }
  function $a(a) {
    (
      ...
      ? (document.cancelFullScreen(), h(N, "on"))
      : (R.requestFullScreen(), f(N, "on"));
  }
  function bb(a) {
  ...
  function ab() {
    if (1 < E) return Z(E - 1);
    if (P || H) return m(L, "transform", "translateX(-" + 100 * F + "%)"), Z(F);
  }
  function U() {
    if (E < F) return Z(E + 1);
    if (P || H) return m(L, "transform", "translateX(100%)"), Z(1);
  }
  function Z(a) {
    if (!((P && B) || a === E)) {
      P || Y();
  ...
  function jb() {
    m(Fa, { transitionDuration: "", transform: "" });
    l(Fa, { transitionDuration: xa + "ms", transform: "translateX(0)" });
  }
  function Oa(a) {
    "boolean" === typeof a ? (ta = a) : ((ta = !ta), Y());
    ta ? f(M, ua) : h(M, ua);
  }
  function Ka(a) {
    r = q = 0;
    ...
    l(L, "transition", e ? "" : "none");
    Ja();
    I && W();
    if (K) {
      l(K, { opacity: d ? 0 : 1, transform: "" });
      var X = K;
      setTimeout(function () {
        X && K !== X && X.parentNode && X.parentNode.removeChild(X);
      }, 800);
    }
    e = Pa();
    x && f(K, x);
    ...
    e && l(K, { visibility: "visible", opacity: 1, transform: "" });
    x && h(K, x);
    W();
    l(Ba, "visibility", H || 1 !== E ? "" : "hidden");
    l(Ca, "visibility", H || E !== F ? "" : "hidden");
    a = S[E - 1];
    if ((c = (c = a.title || a.description) && "false" !== c))
      ka(za, a.title || ""), ka(Aa, a.description || "");
    l(ya, "visibility", c ? "visible" : "hidden");
    ka(Da, E + " / " + F);
    wa && wa(E);
  }
  var hb =
